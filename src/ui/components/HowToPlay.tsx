      ...
      <div className="sheet__body howto" onClick={(ev) => ev.stopPropagation()}>
        ...
        <ol className="howto__steps">
          ...
          <li className="howto__step">
            ...
            <span>
              <strong>Spend Clarity ◈ to see more.</strong> Redraw a seat, whisper one word of a card, turn it over, hold it back for the next seat, or hold a lamp over the seat to see what each card in the hand would do there. Pull a card down to redraw.
            </span>
          </li>
          <li>
